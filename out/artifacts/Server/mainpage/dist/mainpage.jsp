    ...
    <div class="container px-lg-5">
        <div class="p-4 p-lg-5 bg-light rounded-3 text-center">
            <div class="m-4 m-lg-5">
                <h1 class="display-5 fw-bold">동아리방 관리 페이지에 오신걸 환영합니다.</h1>
                <p class="fs-4">부원 출입관리 및 동아리방을 효율적으로 관리하기 위한 페이지 입니다.</p>
            ...
            <div class="col-lg-6 col-xxl-4 mb-5">
                <div class="card bg-light border-0 h-100">
                    <div class="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                        <div class="feature bg-primary bg-gradient text-white rounded-3 mb-4 mt-n4"><a class="bi bi-patch-check" href="./Club_A.jsp?table_number=1"></a></div>
                        <h2 class="fs-4 fw-bold">A동아리</h2>
